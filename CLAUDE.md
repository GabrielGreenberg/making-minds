...
_Last updated: 2026-09-10 (**box naming: unique defaults + student renaming** — default names
...
- **Instructor side** — role-gated `#/instructor` mode: dashboard (with drag-to-reorder
