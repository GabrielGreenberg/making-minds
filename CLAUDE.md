...
that case, loaded, recorded vs live verdict); Home and the overview re-fetch on every visit. **Viewing a
...
**Mark done**: a per-question self-lock toggle with an "N of M done" summary. A **Feedback**
