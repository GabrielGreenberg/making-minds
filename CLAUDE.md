...
- **Instructor side** — role-gated `#/instructor` mode: a **Roster & accounts** screen
  ...
  remove one person, approve or reject access requests), dashboard (with drag-to-reorder
