...
_Last updated: 2026-07-07 (**P4.2 — multi-arena navigation grading with teeth** — a turbot
...
Exhibit (pinned in turbotCheck's new `[multi-arena]` section, 12 checks): 1×8 corridor,
block at x=3/5/7 with the goal just before it — a hardcoded out-2-back-2 FSM passes the
1-arena family 1/1 but fails the 3-arena family 1/3 (arenas #2/#3: returned home without
visiting the goal), an out-4-back-4 brain gets 2/3 ≠ pass, the 3-state sensor-reactive
Mad Max FSM passes 3/3, the lazy stop-now brain 0/3; two headless Gradebook-logic pins
(score 0, failedCount 2 of 3). Earlier same day: **merge #3: server groundwork + grade release + manual grading**
