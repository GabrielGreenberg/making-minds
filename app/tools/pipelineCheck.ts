// Headless end-to-end check of the autograding pipeline for CC, SC, and FSM.
//
...
// one scores below 100%. This validates the grader + the SC/FSM test-vector
// format adapters against real circuits, independent of the browser/UI.
...
check('correct: 3/3 questions', cs.questionsPassed === 3 && cs.questionsTotal === 3);
...
check('incorrect: 0/3 questions', ws.questionsPassed === 0 && ws.questionsTotal === 3);
