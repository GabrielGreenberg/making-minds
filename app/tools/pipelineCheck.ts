...
check('correct: 13/13 questions', cs.questionsPassed === 13 && cs.questionsTotal === 13);
...
check('incorrect: 0/13 questions', ws.questionsPassed === 0 && ws.questionsTotal === 13);
