...
export function QuestionCreator({ assignmentId, existingQuestion, onSave, onCancel }: Props) {
  ...
  const structuralErrors = isTurbot || isPerception ? [] : validateGroups(inputs, outputs, rep, mode);
  ...
  const probe = structurallyValid && !isTurbot && !isPerception
