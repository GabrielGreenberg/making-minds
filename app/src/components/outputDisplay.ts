...
// so headless checks (tools/scWindowCheck.ts and scratch harnesses) can pin
// it. It pins the display DIRECTION: time flows right-to-left in SC and FSM tables — t1 on the right,
